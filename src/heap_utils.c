...
size_t	get_smallest_child(t_queue *wait_queue, size_t index)
{
	...
	if (left_child_index < wait_queue->size
		&& is_priority(wait_queue->node[left_child_index], wait_queue->node[smallest_index]))
			smallest_index = left_child_index;
	if (right_child_index < wait_queue->size
		&& is_priority(wait_queue->node[right_child_index], wait_queue->node[smallest_index]))
